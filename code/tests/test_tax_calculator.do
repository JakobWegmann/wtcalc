...
***** Template to display specific values

*** LST
/*
clear
set obs 1
gen bruttolohn_y = 3000
gen re4 = bruttolohn_y * 100
...
local failure = 0
set obs 1
gen inc_partner_a = 50000
gen inc_partner_b = 30000
...
forvalues stkl = 3 / 5 {
    gen taxes_`stkl'_a = lstlzz_stkl`stkl'_a + solzlzz_stkl`stkl'_a   
    gen taxes_`stkl'_b = lstlzz_stkl`stkl'_b + solzlzz_stkl`stkl'_b   
}

gen sum_taxes_35 = taxes_3_a + taxes_5_b
gen sum_taxes_44 = taxes_4_a + taxes_4_b
gen sum_taxes_53 = taxes_5_a + taxes_3_b
*/
